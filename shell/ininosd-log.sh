...
mkdir -p /var/lib/ceph/osd/ceph-0-journal
mkdir -p /var/lib/ceph/osd/ceph-1
mkdir -p /var/lib/ceph/osd/ceph-1-journal
mkdir -p /var/lib/ceph/osd/ceph-2
mkdir -p /var/lib/ceph/osd/ceph-2-journal
mkdir -p /var/lib/ceph/osd/ceph-3
mkdir -p /var/lib/ceph/osd/ceph-3-journal
mkdir -p /var/lib/ceph/osd/ceph-4
mkdir -p /var/lib/ceph/osd/ceph-4-journal

echo "All dirs are done"
sleep 2
